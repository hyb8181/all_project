	...
	<body>
		<%
			...
			if(names.hasMoreElements()){
				...
				String url = "http://mobile.tx.com.cn:8082/mtkclient/viewalbum.do";
				HttpClientUtil util = new HttpClientUtil();
				showStr = util.postStr(url, map);
			}
		 %>
		<table>
		DEMO:<br/>viewerId=60815935<br/>ownerId=60815935<br/>imsi=310260000000000<br/>phonenum=15026807270<br/>categoryId=1<br/>
		<br/>-----------------------------------------------------------------------<br/>
			<form action="album.jsp" method="post">
				...
				<input type="submit" name="submit" value="查看"/><br/>
			</form>
		</table>
		<table>
			<%=showStr %>
