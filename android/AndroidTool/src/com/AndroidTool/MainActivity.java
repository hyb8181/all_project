...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bt2.setOnClickListener(new OnClickListener(){
        	public void onClick(View arg0){
        		//进入提交建议界面
        		startActivity(new Intent(MainActivity.this,SettingSuggestActivity.class));
        	}
        });
        bt3.setOnClickListener(new OnClickListener(){
        	public void onClick(View arg0){
        		//进入自动更新界面
        		startActivity(new Intent(MainActivity.this,SettingUpdateTestActivity.class));
        	}
        });
        bt4.setOnClickListener(new OnClickListener(){
        	public void onClick(View arg0){
        		//进入JNI界面
        		startActivity(new Intent(MainActivity.this,NdkMainActivity.class));
        	}
        });
    }
}