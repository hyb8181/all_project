...
public class TxActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (user == null) {
			Toast.makeText(TxActivity.this, getString(R.string.login_sys_err),
		...
		//创建Menu的弹出动画-TranslateAnimation
        showAction = new TranslateAnimation(Animation.RELATIVE_TO_PARENT
        		, 0.0f
        ...
        //创建Menu的收缩动画-TranslateAnimation
        hideAction = new TranslateAnimation(Animation.RELATIVE_TO_PARENT
        		, 0.0f
        		, Animation.RELATIVE_TO_PARENT
        		, 0.0f
        		, Animation.RELATIVE_TO_PARENT
...
//			String urlStr = "http://txjoys.cn:1015/api/c/ad/10238?uid=0&ip=0&imsi=0&width=0";
...
//			super.onPageFinished(view, url);
	...
	public void showUpdateDialog() {
        ...
        AlertDialog alert = new AlertDialog.Builder(this)
                ...
                .setMessage("确定退出" + getString(R.string.flat_name_farm) + "?")
	...
	* **/
	...
	private class LoadAdTask extends AsyncTask<String,Void,Ad>{
	    ...
	    protected void onPostExecute(Ad ad) {
			...
			//将HVGA屏(320x480)作为标准屏，广告图片尺寸设置为320x50，计算当前图片的缩放尺寸
			float ww = 320;
			float hh = 50;
