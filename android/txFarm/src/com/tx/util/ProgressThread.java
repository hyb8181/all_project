...
public class ProgressThread implements Runnable {
	...
	public ProgressThread(Activity activity,ProgressDialog progressDialog,App app) {
		...
		fileName = downloadUrl.substring(downloadUrl
	...
	public void uploadZip() {
		...
		if (isRun) {
			try {
				...
				dirs = new File(UrlConfigUtil.APP_URL + File.separator
						+ app.getEnName());
	...
	public void unZip() {
		...
		while (isRun) {
			...
			if (fileExName.equalsIgnoreCase("zip")) {
				...
				String downloadedDir = UrlConfigUtil.APP_URL + File.separator
						+ app.getEnName() + fileName;
				...
				targetDir = UrlConfigUtil.APP_URL + File.separator
						+ app.getEnName() + File.separator;
