...
/*	public PersonInfo(String strId, String strName,
			String strNumber1, String strNumber1_type,
			String strNumber2, String strNumber2_type,
			String strNumber3, String strNumber3_type,
			String strNumber4, String strNumber4_type,
			String strEmail1, String strEmail1_type,
			String strEmail2, String strEmail2_type,
			String strEmail3, String strEmail3_type,
			String strEmail4, String strEmail4_type,
			String strAdd1_Street, String strAdd1_POBox, String strAdd1_Suqare, String strAdd1_City, String strAdd1_PostalCode, String strAdd1_State, String strAdd1_Country, String strAdd1_type,
			String strAdd2_Street, String strAdd2_POBox, String strAdd2_Suqare, String strAdd2_City, String strAdd2_PostalCode, String strAdd2_State, String strAdd2_Country, String strAdd2_type,
			String strAdd3_Street, String strAdd3_POBox, String strAdd3_Suqare, String strAdd3_City, String strAdd3_PostalCode, String strAdd3_State, String strAdd3_Country, String strAdd3_type,
			String strAdd4_Street, String strAdd4_POBox, String strAdd4_Suqare, String strAdd4_City, String strAdd4_PostalCode, String strAdd4_State, String strAdd4_Country, String strAdd4_type,
			String strOrgCmp, String strOrgPoz, String strState){
		this.strId=strId;
        this.strName=strName;
        this.strNumber1=strNumber1;
        this.strNumber1_type=strNumber1_type;
        this.strNumber2=strNumber2;
        this.strNumber2_type=strNumber2_type;
        this.strNumber3=strNumber3;
        this.strNumber3_type=strNumber3_type;
        this.strNumber4=strNumber4;
        this.strNumber4=strNumber4_type;
        this.strEmail1=strEmail1;
        this.strEmail1_type=strEmail1_type;
        this.strEmail2=strEmail2;
        this.strEmail2_type=strEmail2_type;
        this.strEmail3=strEmail3;
        this.strEmail3_type=strEmail3_type;
        this.strEmail4=strEmail4;
        this.strEmail4_type=strEmail4_type;
        this.strAdd1_Street=strAdd1_Street;
        this.strAdd1_POBox=strAdd1_POBox;
        this.strAdd1_Suqare=strAdd1_Suqare;
        this.strAdd1_City=strAdd1_City;
        this.strAdd1_PostalCode=strAdd1_PostalCode;
        this.strAdd1_State = strAdd1_State;
        this.strAdd1_Country=strAdd1_Country;
        this.strAdd1_type=strAdd1_type;
        this.strAdd2_Street=strAdd1_Street;
        this.strAdd2_POBox=strAdd1_POBox;
        this.strAdd2_Suqare=strAdd1_Suqare;
        this.strAdd2_City=strAdd1_City;
        this.strAdd2_PostalCode=strAdd1_PostalCode;
        this.strAdd2_State = strAdd1_State;
        this.strAdd2_Country=strAdd1_Country;
        this.strAdd2_type=strAdd1_type;
        this.strAdd3_Street=strAdd1_Street;
        this.strAdd3_POBox=strAdd1_POBox;
        this.strAdd3_Suqare=strAdd1_Suqare;
        this.strAdd3_City=strAdd1_City;
        this.strAdd3_PostalCode=strAdd1_PostalCode;
        this.strAdd3_State = strAdd1_State;
        this.strAdd3_Country=strAdd1_Country;
        this.strAdd3_type=strAdd1_type;
        this.strAdd4_Street=strAdd1_Street;
        this.strAdd4_POBox=strAdd1_POBox;
        this.strAdd4_Suqare=strAdd1_Suqare;
        this.strAdd4_City=strAdd1_City;
        this.strAdd4_PostalCode=strAdd1_PostalCode;
        this.strAdd4_State = strAdd1_State;
        this.strAdd4_Country=strAdd1_Country;
        this.strAdd4_type=strAdd1_type;
...
*/
	...
	public boolean comparePersonInfo(PersonInfo person){
		if((""+this.strName).equals(""+person.strName) &&
				(""+this.strName).equals(""+person.strName) &&
				(""+this.strNumber1).equals(""+person.strNumber1) &&
				(""+this.strNumber1_type).equals(""+person.strNumber1_type) &&
				(""+this.strNumber2).equals(""+""+person.strNumber2) &&
				(""+this.strNumber2_type).equals(""+person.strNumber2_type) &&
				(""+this.strNumber3).equals(""+person.strNumber3) &&
				(""+this.strNumber3_type).equals(""+person.strNumber3_type) &&
				(""+this.strNumber4).equals(""+person.strNumber4) &&
				(""+this.strNumber4_type).equals(""+person.strNumber4_type) &&
				(""+this.strEmail1).equals(""+person.strEmail1) &&
				(""+this.strEmail1_type).equals(""+person.strEmail1_type) &&
				(""+this.strEmail2).equals(""+person.strEmail2) &&
				(""+this.strEmail2_type).equals(""+person.strEmail2_type) &&
				(""+this.strEmail3).equals(""+person.strEmail3) &&
				(""+this.strEmail3_type).equals(""+person.strEmail3_type) &&
				(""+this.strEmail4).equals(""+person.strEmail4) &&
				(""+this.strEmail4_type).equals(""+person.strEmail4_type) &&
				(""+this.strAdd1_Street).equals(""+person.strAdd1_Street) &&
				(""+this.strAdd1_POBox).equals(""+person.strAdd1_POBox) &&
				(""+this.strAdd1_Suqare).equals(""+person.strAdd1_Suqare) &&
				(""+this.strAdd1_City).equals(""+person.strAdd1_City) &&
				(""+this.strAdd1_State).equals(""+person.strAdd1_State) &&
				(""+this.strAdd1_PostalCode).equals(""+person.strAdd1_PostalCode) &&
				(""+this.strAdd1_Country).equals(""+person.strAdd1_Country) &&
				(""+this.strAdd1_type).equals(""+person.strAdd1_type) &&
				(""+this.strAdd2_Street).equals(""+person.strAdd2_Street) &&
				(""+this.strAdd2_POBox).equals(""+person.strAdd2_POBox) &&
				(""+this.strAdd2_Suqare).equals(""+person.strAdd2_Suqare) &&
				(""+this.strAdd2_City).equals(""+person.strAdd2_City) &&
				(""+this.strAdd2_State).equals(""+person.strAdd2_State) &&
				(""+this.strAdd2_PostalCode).equals(""+person.strAdd2_PostalCode) &&
				(""+this.strAdd2_Country).equals(""+person.strAdd2_Country) &&
				(""+this.strAdd2_type).equals(""+person.strAdd2_type) &&
				(""+this.strAdd3_Street).equals(""+person.strAdd3_Street) &&
				(""+this.strAdd3_POBox).equals(""+person.strAdd3_POBox) &&
				(""+this.strAdd3_Suqare).equals(""+person.strAdd3_Suqare) &&
				(""+this.strAdd3_City).equals(""+person.strAdd3_City) &&
				(""+this.strAdd3_State).equals(""+person.strAdd3_State) &&
				(""+this.strAdd3_PostalCode).equals(""+person.strAdd3_PostalCode) &&
				(""+this.strAdd3_Country).equals(""+person.strAdd3_Country) &&
				(""+this.strAdd3_type).equals(""+person.strAdd3_type) &&
				(""+this.strAdd4_Street).equals(""+person.strAdd4_Street) &&
				(""+this.strAdd4_POBox).equals(""+person.strAdd4_POBox) &&
				(""+this.strAdd4_Suqare).equals(""+person.strAdd4_Suqare) &&
				(""+this.strAdd4_City).equals(""+person.strAdd4_City) &&
				(""+this.strAdd4_State).equals(""+person.strAdd4_State) &&
				(""+this.strAdd4_PostalCode).equals(""+person.strAdd4_PostalCode) &&
				(""+this.strAdd4_Country).equals(""+person.strAdd4_Country) &&
				(""+this.strAdd4_type).equals(""+person.strAdd4_type) &&
				(""+this.strOrgCmp).equals(""+person.strOrgCmp) &&
				(""+this.strOrgPoz).equals(""+person.strOrgPoz))
		{
			return true;
		}
		else
...
/*
	public PersonInfo() {
        ...
        this.strName="";
        this.strNumber1="";
        this.strNumber1_type="";
        this.strNumber2="";
        this.strNumber2_type="";
        this.strNumber3="";
        this.strNumber3_type="";
        this.strNumber4="";
        this.strNumber4_type="";
        this.strEmail1="";
        this.strEmail1_type="";
        this.strEmail2="";
        this.strEmail2_type="";
        ...
        this.strAdd1_Suqare="";
        this.strAdd1_City="";
        this.strAdd1_PostalCode="";
        this.strAdd1_State = "";
        this.strAdd1_Country="";
        this.strAdd1_type="";
        this.strAdd2_Street="";
        this.strAdd2_POBox="";
        this.strAdd2_Suqare="";
        this.strAdd2_City="";
        this.strAdd2_PostalCode="";
        this.strAdd2_State = "";
        this.strAdd2_Country="";
        this.strAdd2_type="";
        this.strAdd3_Street="";
        this.strAdd3_POBox="";
        this.strAdd3_Suqare="";
        this.strAdd3_City="";
        this.strAdd3_PostalCode="";
        this.strAdd3_State = "";
        this.strAdd3_Country="";
        this.strAdd3_type="";
        this.strAdd4_Street="";
        this.strAdd4_POBox="";
        this.strAdd4_Suqare="";
        this.strAdd4_City="";
        this.strAdd4_PostalCode="";
        this.strAdd4_State = "";
        this.strAdd4_Country="";
        this.strAdd4_type="";
        this.strOrgCmp="";
        this.strOrgPoz="";
        this.strState="";
	...
	public PersonInfo(String strId) {
		this.strId = strId;
		// TODO Auto-generated constructor stub
	}*/
